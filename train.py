...
def train():
    ...
    speech_test = '/home3/sining/sound_class/test/'

    model.fit_generator(
        dataset.get_gen_train(FLAGS, speech_train, batch_size=FLAGS.batch_size),
        epochs=80, verbose=1, steps_per_epoch=1600 // FLAGS.batch_size,
        validation_data=dataset.get_gen_train(FLAGS, speech_train, batch_size=FLAGS.batch_size),
        validation_steps=1600 // FLAGS.batch_size,
